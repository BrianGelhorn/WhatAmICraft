...
assert "iconRotation" in cooldown and "useProgress" in cooldown and "readyBlend" in cooldown and "mixHex" in cooldown
assert 'opacity: 1 - readyBlend' in cooldown and 'opacity: readyBlend' in cooldown
